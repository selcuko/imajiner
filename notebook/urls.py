...
urlpatterns = [
    ...
    path(_('translate/<uuid:uuid>/'), AddTranslation.as_view(), kwargs={'redirect': False}, name='translate'),
    path(_('retranslate/<uuid:uuid>/'), AddTranslation.as_view(), kwargs={'redirect': True}, name='retranslate'),
