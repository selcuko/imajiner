...
urlpatterns = [
    ...
    path('konsol/hikayeler/<uuid:uuid>/surumler/', NarrativeVersions.as_view(), name='versions'),
    path('konsol/hikayeler/<uuid:narrative>/surumler/<uuid:version>/', NarrativeVersion.as_view(), name='version'),
